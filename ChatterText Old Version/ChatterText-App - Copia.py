...
def build_python_script(chunks, default_exag, default_cfg, default_temp,
    ...
    lines = [
        ...
        "        return strip_pauses(clean), 'v1', e, pauses",
        "    return strip_pauses(chunk), 'v1', None, pauses",
        "",
