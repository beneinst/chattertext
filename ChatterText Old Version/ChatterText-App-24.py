...
# =========================================================
# UTILITY: formatta secondi in mm:ss
# =========================================================
...
Sei un editor specializzato nella preparazione di testi per sintesi vocale avanzata con Chatterbox TTS.

Il tuo compito è RISCRIVERE il capitolo fornito applicando il sistema di tag ChatterText v2.4
E preparando il testo in modo ottimale per la lettura ad alta voce.

Il lavoro si divide in DUE FASI obbligatorie, da eseguire nell'ordine indicato.

========================================================
FASE 1 — PULIZIA E PREPARAZIONE DEL TESTO
========================================================

Esegui TUTTE le seguenti trasformazioni prima di applicare i tag.

--------------------------------------------------------
1.1 NUMERI → LETTERE
--------------------------------------------------------

Converti SEMPRE i numeri in parole italiane.
...
Esempi obbligatori:
  ...
  100        → cento
  1.200      → milleduecento
  3,5        → tre virgola cinque
  1° / 1°   → primo
  2°         → secondo
  XXI        → ventunesimo
  2024       → duemilaventiquattro
  ore 9:30   → ore nove e trenta
  §3         → paragrafo tre
  cap. 4     → capitolo quattro

Attenzione ai contesti:
  "nel 1800"         → "nell'ottocento" oppure "nel milleottocento"
  "anni '90"         → "anni novanta"
  "pagina 42"        → "pagina quarantadue"
  "temperatura 37°"  → "temperatura di trentasette gradi"

--------------------------------------------------------
1.2 SIMBOLI E CARATTERI SPECIALI → PAROLE
--------------------------------------------------------
  ...
  $          → dollari
  £          → sterline
  +          → più  (in contesti matematici o comparativi)
  –  /  —    → virgola oppure pausa (sostituire con punteggiatura)
  ...        → lasciare come "..." (verrà letto come pausa naturale)
  "..."      → rimuovere le virgolette, mantenere il contenuto
  (...)      → valutare: se inciso, racchiudere con virgole; se irrilevante, eliminare
  /          → "o" oppure "e" a seconda del contesto
  @          → chiocciola (solo se inevitabile, altrimenti riformulare)
  #          → numero (solo se inevitabile)
  *testo*    → rimuovere gli asterischi, mantenere il testo
  _testo_    → rimuovere i trattini bassi, mantenere il testo

--------------------------------------------------------
1.3 ABBREVIAZIONI → FORMA ESTESA
--------------------------------------------------------

Espandi SEMPRE le abbreviazioni, il TTS le legge male.

  Dr. / Dott.   → Dottor / Dottoressa
  Prof.         → Professor / Professoressa
  Sig. / Sig.ra → Signor / Signora
  es.           → per esempio
  ecc.          → eccetera
  etc.          → eccetera
  vs.           → contro  (oppure "rispetto a" se comparativo)
  N.B.          → nota bene
  P.S.          → post scriptum
  ca. / circa   → circa
  km            → chilometri
  m             → metri  (solo se unità di misura, non pronome)
  cm            → centimetri
  kg            → chilogrammi
  mg            → milligrammi
  ml            → millilitri
  ...
  cap.          → capitolo
  vol.          → volume
  ed.           → edizione  (se non è congiunzione "ed")
  Op.           → opera
  trad.         → traduzione di

--------------------------------------------------------
1.4 SIGLE E ACRONIMI → FORMA LEGGIBILE
--------------------------------------------------------

Valuta caso per caso:

- Acronimi pronunciabili come parola → lasciare in maiuscolo (NATO, UNESCO, ONU)
  ma assicurarsi che il TTS li legga come parola intera, non lettera per lettera.
  Se ambiguo, separare con punti: N.A.T.O. oppure scrivere per esteso.

- Sigle lette lettera per lettera → aggiungere punti o scrivere per esteso:
  USA    → U.S.A. oppure "Stati Uniti"
  UE     → Unione Europea (in contesti formali)
  TTS    → T.T.S. oppure "sintesi vocale"
  AI     → A.I. oppure "intelligenza artificiale"
  PC     → P.C. oppure "computer"
  TV     → T.V. oppure "televisione"
  URL    → U.R.L.
  PDF    → P.D.F.
  CEO    → A.D. oppure "amministratore delegato"

--------------------------------------------------------
1.5 PUNTEGGIATURA — REVISIONE COMPLETA
--------------------------------------------------------

La punteggiatura è il "respiro" del testo parlato. Revisiona con attenzione.

REGOLE PRINCIPALI:

a) Frasi troppo lunghe → spezzare con virgola o punto
   Ogni frase ideale per il parlato: 10–20 parole.
   Frasi sopra 25 parole vanno quasi sempre spezzate.

b) Virgola prima di "ma", "però", "tuttavia", "eppure", "anzi"
   Esempio: "Era stanco, ma continuò."

c) Due punti per introdurre elenchi o spiegazioni
   Esempio: "Aveva tre paure: il buio, il silenzio, la solitudine."

d) Punto e virgola per separare elementi paralleli lunghi
   Esempio: "Da un lato la ragione; dall'altro il cuore."

e) Puntini di sospensione (...) solo per pause vere o frasi incompiute
   Non usarli al posto della virgola.

f) Punto esclamativo (!) con parsimonia: massimo 1 ogni 3–4 frasi di dialogo.

g) Punto interrogativo (?) solo per domande dirette, mai retoriche esplicite
   che interrompono il flusso narrativo.

h) Eliminare la punteggiatura ridondante: !!!, ???, ..., ,, ecc.

i) Virgolette nel dialogo → trasformare in formato narrativo con trattino
   oppure rimuovere e usare solo i tag [v1]/[v2] per distinguere le voci.

--------------------------------------------------------
1.6 ACCENTI E DIZIONE ITALIANA
--------------------------------------------------------

Aggiungi accenti grafici e correzioni fonetiche per una dizione precisa.

PAROLE CON ACCENTO OBBLIGATORIO (spesso scritte senza):
  perche    → perché
  pero      → però
  cioe      → cioè
  gia       → già
  piu       → più
  e (cong.) → è  (quando è il verbo "essere": "la risposta è chiara")
  si (avv.) → sì  (quando significa "yes": "disse di sì")
  ne        → né  (quando è congiunzione negativa: "né l'uno né l'altro")
  la (avv.) → là  (quando indica luogo: "là in fondo")
  li (avv.) → lì  (quando indica luogo: "lì vicino")
  da (vb.)  → dà  (quando è verbo dare: "mi dà fastidio")
  se (cong.)→ sé  (quando è pronome: "pensava a sé stesso")

PAROLE CON PRONUNCIA AMBIGUA → riformulare o aggiungere contesto:
  "ancora"  → distinguere àncora (oggetto) da ancóra (avverbio)
              Se ambiguo nel contesto, riformulare.
  "subito"  → distinguere sùbito (immediatamente) da subìto (participio)
  "principi"→ distinguere prìncipi (plurale di principe) da princìpi (valori)
  Quando ambiguo: riformulare la frase per eliminare il dubbio.

DOPPIE E CONSONANTI:
  Non modificare le doppie presenti. Aggiungere solo se il TTS tende
  a leggere male parole note (es. "affare" non "afare").

--------------------------------------------------------
1.7 ELISIONI E APOSTROFI
--------------------------------------------------------

  dell'uomo   → mantenere (corretto)
  dell' uomo  → correggere in "dell'uomo" (spazio errato)
  un'altra    → mantenere
  po'         → mantenere (troncamento corretto)
  l'amore     → mantenere

  Evitare apostrofo prima di consonante:
  "un'palazzo" → "un palazzo"

--------------------------------------------------------
1.8 PAROLE STRANIERE E NOMI PROPRI
--------------------------------------------------------

- Nomi di luoghi e persone stranieri: mantenerli ma verificare che
  il TTS italiano li legga correttamente. Se è noto che un nome
  viene letto male, aggiungere una nota fonetica tra parentesi tonde
  oppure riformulare con "il personaggio chiamato X".

- Parole inglesi comuni nel testo italiano → valutare:
  "computer", "internet", "email" → lasciare (pronuncia stabile in italiano)
  "achievement", "workflow"       → tradurre o riformulare
  Titoli di opere (libri, film)   → mantenere in originale tra virgolette
                                    se noti, altrimenti tradurre.

- Parole latine: pronunciare all'italiana (non alla classica).
  "et cetera" → lasciare oppure sostituire con "eccetera"

--------------------------------------------------------
1.9 RIPETIZIONI E RITMO
--------------------------------------------------------

- Identificare parole ripetute a breve distanza (stesso paragrafo)
  e sostituire con sinonimi o pronomi, senza stravolgere il significato.

- Evitare l'inizio di frasi consecutive con la stessa parola.

- Frasi nominali brevi isolate ("Silenzio.", "Buio totale.") sono
  efficaci per il parlato: mantenerle o crearle deliberatamente
  per enfasi, ma solo se il chunk ha almeno 5 parole totali nel blocco.

- Non eliminare le ripetizioni stilistiche volute dall'autore
  (anafore, tricolon, ecc.): sono scelte narrative, non errori.

========================================================
FASE 2 — APPLICAZIONE DEI TAG ChatterText v2.4
========================================================

Solo dopo aver completato la Fase 1, applica i tag.

--------------------------------------------------------
REGOLA FONDAMENTALE — BLOCCO RESPIRO
--------------------------------------------------------

Ogni blocco [inizio]...[fine] = UNA unità di respiro.

  - minimo 5 parole pulite (esclusi tag)
  - massimo consigliato 14 parole
  - massimo consigliato 80 caratteri
  - ogni blocco = UNA frase breve o un'unità logica completa

Chunk troppo corti → ripetizioni/anomalie TTS.
Chunk troppo lunghi → perdita di naturalezza e interpretazione.
...
OGNI blocco deve SEMPRE:
1. aprirsi con [inizio]
2. chiudersi con [fine]
3. contenere almeno un tag voce
4. terminare con almeno un tag pausa/giunzione prima di [fine]
...
[v1]testo[/v1]                  → Voce 1
[v2]testo[/v2]                  → Voce 2
[v3]testo[/v3]                  → Voce 3 opzionale

[V1_emozione]...[/V1_emozione]  → Voce 1 emotiva
[V2_emozione]...[/V2_emozione]  → Voce 2 emotiva
[V3_emozione]...[/V3_emozione]  → Voce 3 emotiva

RUOLI CONSIGLIATI:
  V1 = narratore / protagonista / voce principale
  V2 = personaggio secondario / interlocutore
  V3 = terzo personaggio / pensiero interiore / flashback

NOTA: V3 è facoltativa. Usarla solo se narrativamente necessaria.
...
--------------------------------------------------------
GIUNZIONI TRA CHUNK — 8 LIVELLI
--------------------------------------------------------

  [join]    → 0.00s   overlap totale       — stessa frase spezzata
  [cont]    → 0.12s   transizione morbida  — stessa idea continua
  [cambio]  → 0.50s   cambio voce V1 ↔ V2 — dialogo diretto
  [cambio3] → 0.50s   cambio voce con V3   — entrata/uscita V3
  [para]    → 0.90s   pausa netta          — fine paragrafo
  [stacco]  → 1.40s   pausa forte          — cambio pensiero
  [lungo]   → 1.80s   pausa riflessiva     — tensione / sospensione
  [scena]   → 2.40s   stacco completo      — cambio scena / capitolo

REGOLE GIUNZIONI VOCI:
  V1 ↔ V2       = [cambio]
  V1/V2 → V3    = [cambio3]
  V3 → V1/V2    = [cambio3]
...
--------------------------------------------------------
  ...
  [p3]  → ~0.65s   pausa riflessiva / punto e virgola
  [b]   → ~1.00s   cambio idea / due punti
  [bd]  → ~1.60s   climax / rivelazione / tensione
  [cap] → ~2.00s   reset narrativo / capoverso forte
...
--------------------------------------------------------
  ...
  [e1]  → enfasi leggera
  [e2]  → enfasi forte (max 1 ogni 2–3 blocchi)

========================================================
ESEMPIO COMPLETO (dopo Fase 1 + Fase 2)
========================================================

Testo originale:
  "Era il 3° giorno. Aveva percorso 15km. Pensò: adesso basta!"

Dopo Fase 1:
  "Era il terzo giorno. Aveva percorso quindici chilometri.
   Pensò: adesso basta!"
...
[inizio]
[V1_calmo]
Era il terzo giorno.[p2][cont]
[/V1_calmo]
[fine]

[inizio]
[V1_riflessivo]
Aveva percorso quindici chilometri.[p3][stacco]
[/V1_riflessivo]
[fine]

[inizio]
[V1_deciso]
Pensò:[p1] adesso basta![e1][bd][para]
[/V1_deciso]
[fine]
...
========================================================
 ...
 1. Eseguire SEMPRE la Fase 1 prima di applicare i tag.
 2. MAI chunk sotto 5 parole pulite.
 3. SEMPRE rispettare il blocco-respiro naturale.
 4. SEMPRE inserire tag pausa/giunzione prima di [fine].
 5. NON abusare delle pause.
 6. NON abusare delle enfasi.
 7. Mantenere ritmo naturale e cinematografico.
 8. Adattare l'emozione al contenuto della frase.
 9. Preferire V1 salvo necessità narrativa.
10. Usare V3 solo se utile.
11. NON modificare il significato del testo originale.
12. NON aggiungere contenuti non presenti nell'originale.
13. L'output deve essere pronto per uso diretto in ChatterText.

========================================================

Ora elabora il seguente capitolo applicando ESATTAMENTE queste regole,
prima la Fase 1 (pulizia testo) poi la Fase 2 (tag ChatterText):
...
"# Sopprimi warning non critici per avvio più rapido",
"warnings.filterwarnings('ignore', category=FutureWarning)",
"warnings.filterwarnings('ignore', category=UserWarning)",
"os.environ['TRANSFORMERS_NO_ADVISORY_WARNINGS'] = '1'",
"os.environ['TOKENIZERS_PARALLELISM'] = 'false'",
"os.environ['HF_HUB_DISABLE_SYMLINKS_WARNING'] = '1'",
"import torch,torchaudio as ta,pathlib,time",
"if sys.platform=='win32':",
"    import io",
...
"        mm,ss=divmod(int(rm),60)",
"        eta='  ETA:{}m{:02d}s'.format(mm,ss) if mm>0 else '  ETA:{:d}s'.format(int(rm))",
"    else: eta=''",
...
"tot_m,tot_s=divmod(int(tot),60)",
"dur_fmt='{}m{:02d}s'.format(dur_m,dur_s) if dur_m>0 else '{:d}s'.format(int(dur))",
"tot_fmt='{}m{:02d}s'.format(tot_m,tot_s) if tot_m>0 else '{:d}s'.format(int(tot))",
"print(f'\\n FILE: {out}')",
"print(f'   Durata audio: {dur_fmt}')",
"print(f'   Tempo totale: {tot_fmt}')",
...
class App(tk.Tk):
    ...
    def _ctrl_sec(self,r):
        ...
        self.vv3=self._le(r2,"Voce 3 (opz.)","",wide=True)
        ...
        # ---- RIGA AZIONI PRINCIPALE (modificata) ----
        br=sf(sec); br.pack(fill="x",pady=(10,0))

        # Genera Audio: primo, colore verde acceso, più evidente
        gen_btn = tk.Button(br, text="▶  Genera Audio",
                            command=self.run_chatterbox,
                            bg=C["success"], fg="#fff",
                            activebackground="#00d9a8", activeforeground="#fff",
                            relief="flat", bd=0, cursor="hand2",
                            font=("Segoe UI", 11, "bold"), padx=20, pady=10)
        gen_btn.bind("<Enter>", lambda e: gen_btn.config(bg="#00d9a8"))
        gen_btn.bind("<Leave>", lambda e: gen_btn.config(bg=C["success"]))
        ...
        sb_btn(br,"Copia Tutti",self.copy_all,color=C["text_dim"]).pack(side="left",padx=(0,10))
    ...
    def _stats_sec(self,r):
        ...
        self.err_box.pack(fill="x",pady=(0,0))
    ...
    def _chunks_sec(self,r):
        # Sezione chunk senza i pulsanti duplicati (ora sono in _ctrl_sec)
    ...
    def process(self):
        ...
        if v3c: pts.append("{} blocchi V3".format(v3c))
    ...
    # ---- SCRIPT ----
    def _mk_script(self):
        if not self.chunks: messagebox.showwarning("Attenzione","Processa prima il testo con 'Analizza e Processa'!"); return None
        ...
        def _run():
            try:
                ...
                if rc==0:
                    ...
                    # Formato mm:ss per il riepilogo nel log
                    el_fmt = fmt_time(el)
                    self._alog("✓ COMPLETATO in {}!\n".format(el_fmt))
                    self._alog("  Chunk generati: {}/{}\n".format(tot,tot))
                    self.after(0,lambda:self.progv.set(100))
                    self.after(0,lambda:self.vprog.set("{}/{} COMPLETATO".format(tot,tot)))
                    self.after(0,lambda ef=el_fmt:self.veta.set("Totale: {}".format(ef)))
                    if self.vsound.get():
                        threading.Thread(target=play_sound,daemon=True).start()
                    # Nessun messagebox: risultati già visibili nel log
                else:
                    self._alog("✗ Errore (exit code {})\n".format(rc))
    ...
    def _uprog(self,pct,n,tot,rem):
        ...
        if rem>0: self.veta.set("ETA: {}".format(fmt_time(rem)))
